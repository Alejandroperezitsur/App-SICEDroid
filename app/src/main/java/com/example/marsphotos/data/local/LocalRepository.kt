...
interface LocalRepository {
    ...
    suspend fun updateKardex(matricula: String, kardex: List<KardexEntity>)
    ...
    suspend fun updateCarga(matricula: String, carga: List<CargaEntity>)
    ...
    suspend fun updateCalifUnidad(matricula: String, calif: List<CalifUnidadEntity>)
    ...
    suspend fun updateCalifFinal(matricula: String, calif: List<CalifFinalEntity>)
...
class LocalRepositoryImpl(private val studentDao: StudentDao) : LocalRepository {
    ...
    override suspend fun updateKardex(matricula: String, kardex: List<KardexEntity>) = studentDao.updateKardex(matricula, kardex)
    ...
    override suspend fun updateCarga(matricula: String, carga: List<CargaEntity>) = studentDao.updateCarga(matricula, carga)
    ...
    override suspend fun updateCalifUnidad(matricula: String, calif: List<CalifUnidadEntity>) = studentDao.updateCalifUnidad(matricula, calif)
    ...
    override suspend fun updateCalifFinal(matricula: String, calif: List<CalifFinalEntity>) = studentDao.updateCalifFinal(matricula, calif)
